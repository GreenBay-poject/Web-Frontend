...
import Map from "../DeforestationReport/map";
import Dateselection from "../DeforestationReport/selectdate";
import ImageSlections from "../DeforestationReport/image";
        ...
        {steps.map((label, index) => (
          <Step key={label}>
            ...
            <StepContent>
              ...
              {index===1 ? <Dateselection dates={dates} setSelectedDate={setSelectedDate} setSelectedDate2={setSelectedDate2}/>: null}
              {index===2 ? <ImageSlections selectedDate={selectedDate} selectedDate2={selectedDate2} latitude={latitude} longitude={longitude} setReportData={setReportData}/>: null}
