...
function Landing(props) {
  ...
  return (
    <Box>
      ...
      <ParallaxProvider>
        <Parallax className={classes.parallax} y={[-5, 0]} tagOuter="figure">
          <Slider />
        </Parallax>
      </ParallaxProvider>

      <ParallaxProvider>
        <Parallax className={classes.parallax} y={[0, 13]} tagOuter="figure">
          <MapExplore isAuthenticated={isAuthenticated} />
        </Parallax>
      </ParallaxProvider>

      <ParallaxProvider>
        <Parallax className={classes.parallax2} y={[50, 0]} tagOuter="figure">
          <Box mt="30px" pl="60px">
      ...
      <ParallaxProvider>
        <Parallax className={classes.parallax2} y={[30, -13]} tagOuter="figure">
          <ColoredBar />
        </Parallax>
      </ParallaxProvider>

      <ParallaxProvider>
        <Parallax className={classes.parallax2} y={[30, -15]} tagOuter="figure">
          <Box mb="15px">
            <hr color={colors[1]} />
      ...
      <ParallaxProvider>
        <Parallax className={classes.parallax2} y={[55, -18]} tagOuter="figure">
          <Grid container direction="row">
            <img width="33%" src="Slideimg/Bottom1.png" alt="Slidrr" />
            <img width="33%" src="Slideimg/Bottom2.png" alt="Slidrr" />
            <img width="33%" src="Slideimg/Bottom3.png" alt="Slidrr" />
          </Grid>
        </Parallax>
      </ParallaxProvider>

      <ParallaxProvider>
        <Parallax className={classes.parallax2} y={[0, 0]} tagOuter="figure">
          <Footer />
        </Parallax>
      </ParallaxProvider>
