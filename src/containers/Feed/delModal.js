          ...
          <div className={classes.modelpaper}>
            <Box>
              ...
              <Grid container direction="row">
                <Grid item xs>
                  <Button className={classes.postbutton2} class="postyesbtn" onClick={handleDelete}>Yes</Button>
                </Grid>
                <Grid item xs>
                  <Button className={classes.postbutton} class="postnobtn" onClick={handleClose}>No</Button>
                </Grid> 
              </Grid>
            </Box>
          </div>
