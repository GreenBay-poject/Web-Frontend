          ...
          <div className={classes.modelpaper}>
            <Box>
              ...
              <Grid container direction="row">
                <Grid item xs>
                  <Button className={classes.postbutton2} id="postyesbtn" onClick={handleDelete}>Yes</Button>
                </Grid>
                <Grid item xs>
                  <Button className={classes.postbutton} id="postnobtn" onClick={handleClose}>No</Button>
                </Grid> 
              </Grid>
            </Box>
          </div>
